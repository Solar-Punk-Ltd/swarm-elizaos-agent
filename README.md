...
| `ANTHROPIC_SMALL_MODEL`             | string  | **optional**                                 | Default: `claude-3-haiku-20240307`.                                                                                                                        |
| `ANTHROPIC_LARGE_MODEL`             | string  | **optional**                                 | Default: `claude-3-5-sonnet-latest`.                                                                                                                       |
...
| `OPENAI_SMALL_MODEL`                | string  | **optional**                                 | Default: `gpt-4o-mini`.                                                                                                                                    |
| `OPENAI_LARGE_MODEL`                | string  | **optional**                                 | Default: `gpt-4o`.                                                                                                                                         |
| `OPENAI_EMBEDDING_MODEL`            | string  | **optional**                                 | Default: `text-embedding-3-small`.                                                                                                                         |
